...
#### THE PEEEERFECT Arrow MATRIX with STX-Average + dots-Reference
#### ADDITIONAL HEATMAP + DENDROGRAMM
...
################################################################################
####PERRRRRRRRRRRRFECT MATRIX with References as dots###########################
################################################################################
df_long <- matrix_ready %>%
    rownames_to_column("Sample") %>%
    pivot_longer(cols = -Sample, names_to = "Gene", values_to = "log2FC") %>%
...
################################################################################
###add STX-Average als letzte Spale                                         ####
################################################################################
...
####%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
####Spalten orden so das alle PASN zusammen & alle TSB zusammen!
